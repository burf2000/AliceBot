...
public class Predicates extends HashMap<String, String> {
    ...
    public String put(String key, String value) {
		...
		//org.alicebot.ab.ab.MagicBooleans.trace("in predicates.put, returning: " + result);
        return result;
    }
    ...
    public String get(String key) {
		//org.alicebot.ab.ab.MagicBooleans.trace("predicates.get(key: " + key + ")");
        String result = super.get(key);
        if (result == null) result = MagicStrings.default_get;
		//org.alicebot.ab.ab.MagicBooleans.trace("in predicates.get, returning: " + result);
        return result;
    }
