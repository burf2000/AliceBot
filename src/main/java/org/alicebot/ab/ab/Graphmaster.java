    ...
    public final Nodemapper match(String input, String that, String topic) {
        ...
        try {
         ...
         if (MagicBooleans.trace_mode) {
             if (n != null) {
				 //org.alicebot.ab.ab.MagicBooleans.trace("in graphmaster.match(), matched "+n.category.inputThatTopic()+" "+n.category.getFilename());
				 if (MagicBooleans.trace_mode) System.out.println ("Matched: "+n.category.inputThatTopic()+" "+n.category.getFilename());
             } else {
				 //org.alicebot.ab.ab.MagicBooleans.trace("in graphmaster.match(), no match.");
		...
		//org.alicebot.ab.ab.MagicBooleans.trace("in graphmaster.match(), returning: " + n);
        return n;
    }
