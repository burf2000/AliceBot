...
public class Chat {
   ...
   // public History<String> repetitionHistory = new History<String>("repetition");
    ...
    String respond(String input, String that, String topic, History contextThatHistory) {
		//org.alicebot.ab.ab.MagicBooleans.trace("chat.respond(input: " + input + ", that: " + that + ", topic: " + topic + ", contextThatHistory: " + contextThatHistory + ")");
		...
		//org.alicebot.ab.ab.MagicBooleans.trace("in chat.respond(), returning: " + result);
		return result;
    }
    ...
    public String multisentenceRespond(String request) {
        ...
        //org.alicebot.ab.ab.MagicBooleans.trace("chat.multisentenceRespond(request: " + request + ")");
        String response="";
        matchTrace="";
        try {
        ...
        //org.alicebot.ab.ab.MagicBooleans.trace("in chat.multisentenceRespond(), returning: " + response);
        return response;
    }
