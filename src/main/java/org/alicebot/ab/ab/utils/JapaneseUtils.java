package org.alicebot.ab.ab.utils;

import net.reduls.sanmoku.Morpheme;
import net.reduls.sanmoku.Tagger;
import org.alicebot.ab.ab.AIMLProcessor;
import org.alicebot.ab.ab.MagicBooleans;
import org.alicebot.ab.ab.MagicStrings;
...
public class JapaneseUtils {
    ...
    public static String tokenizeSentence(String sentence) {
        ...
        result = result.trim();
        //if (org.alicebot.ab.ab.MagicBooleans.trace_mode) System.out.println("tokenizeSentence '"+sentence+"'-->'"+result+"'");
        return result;
    }
