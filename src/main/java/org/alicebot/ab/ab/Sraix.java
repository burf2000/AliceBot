...
import org.alicebot.ab.ab.utils.CalendarUtils;
import org.alicebot.ab.ab.utils.NetworkUtils;
    ...
    public static String sraixPannous(String input, String hint, Chat chatSession)  {
        try {
           ...
           // input = chatSession.bot.preProcessor.denormalize(input);
            ...
            //org.alicebot.ab.ab.MagicBooleans.trace("in Sraix.sraixPannous, page: " + page);
            String text="";
            String imgRef="";
            String urlRef="";
            if (page == null || page.length() == 0) {
				...
				//org.alicebot.ab.ab.MagicBooleans.trace("in Sraix.sraixPannous, outputJson class: " + outputJson.getClass() + ", outputJson: " + outputJson);
                if (outputJson.length() == 0) {
                    text = MagicStrings.sraix_failed;
                }
                else {
                    JSONObject firstHandler = outputJson.getJSONObject(0);
					//org.alicebot.ab.ab.MagicBooleans.trace("in Sraix.sraixPannous, firstHandler class: " + firstHandler.getClass() + ", firstHandler: " + firstHandler);
                    JSONObject actions = firstHandler.getJSONObject("actions");
					//org.alicebot.ab.ab.MagicBooleans.trace("in Sraix.sraixPannous, actions class: " + actions.getClass() + ", actions: " + actions);
                    if (actions.has("reminder")) {
                        //org.alicebot.ab.ab.MagicBooleans.trace("in Sraix.sraixPannous, found reminder action");
                        ...
                        //org.alicebot.ab.ab.MagicBooleans.trace("in Sraix.sraixPannous, obj class: " + obj.getClass());
                        //org.alicebot.ab.ab.MagicBooleans.trace("in Sraix.sraixPannous, obj instanceof JSONObject: " + (obj instanceof JSONObject));
                        if (obj instanceof JSONObject) {
                            JSONObject sObj = (JSONObject) obj;
