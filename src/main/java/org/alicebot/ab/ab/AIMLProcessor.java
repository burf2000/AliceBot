...
import org.alicebot.ab.ab.utils.*;
...
;
 ...
 public static String respond(String input, String that, String topic, Chat chatSession, int srCnt) {
	 MagicBooleans.trace("input: " + input + ", that: " + that + ", topic: " + topic + ", chatSession: " + chatSession + ", srCnt: " + srCnt);
        ...
        response = MagicStrings.default_bot_response;
         try {
			...
			//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.respond(), template: " + template);
    ...
    public static String evalTagContent(Node node, ParseState ps, Set<String> ignoreAttributes) {
		//org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.evalTagContent(node: " + node + ", ps: " + ps + ", ignoreAttributes: " + ignoreAttributes);
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.evalTagContent, node string: " + DomUtils.nodeToString(node));
        String result = "";
        try {
        NodeList childList = node.getChildNodes();
        for (int i = 0; i < childList.getLength(); i++) {
            Node child = childList.item(i);
			//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.evalTagContent(), child: " + child);
            if (ignoreAttributes == null || !ignoreAttributes.contains(child.getNodeName()))
              result += recursEval(child, ps);
			//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.evalTagContent(), result: " + result);
        }
        } catch (Exception ex) {
            System.out.println("Something went wrong with evalTagContent");
            ex.printStackTrace();
        }
		//org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.evalTagContent() returning: " + result);
        return result;
    }
    ...
    public static String genericXML(Node node, ParseState ps) {
		//org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.genericXML(node: " + node + ", ps: " + ps);
        String evalResult = evalTagContent(node, ps, null);
		String result = unevaluatedXML(evalResult, node, ps);
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.genericXML(), returning: " + result);
		return result;
    }
    ...
    private static String unevaluatedXML(String resultIn, Node node, ParseState ps) {
        //org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.unevaluatedXML(resultIn: " + resultIn + ", node: " + node + ", ps: " + ps);
        String nodeName = node.getNodeName();
        //org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.unevaluatedXML(), nodeName: " + nodeName);
        String attributes = "";
       ...
       // String contents = evalTagContent(node, ps, null);
        ...
        //org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.unevaluatedXML() returning: " + result);
		return result;
    }
    ...
    private static String srai(Node node, ParseState ps) {
		//org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.srai(node: " + node + ", ps: " + ps);
        sraiCount++;
		...
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.srai(), returning: " + result);
        return result;
    }
    ...
    private static String getAttributeOrTagValue (Node node, ParseState ps, String attributeName) {        // AIML 2.0
        //org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.getAttributeOrTagValue (node: " + node + ", attributeName: " + attributeName + ")");
        String result = "";
		...
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.getAttributeOrTagValue (), returning: " + result);
        return result;
    }
    ...
    private static String set(Node node, ParseState ps) {                    // add pronoun check
		//org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.set(node: " + node + ", ps: " + ps + ")");
		...
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.set, returning: " + result);
		return result;
    }
    ...
    private static String get(Node node, ParseState ps) {
		//org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.get(node: " + node + ", ps: " + ps + ")");
		...
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.get, returning: " + result);
        return result;
    }
    ...
    private static String normalize(Node node, ParseState ps) {            // AIML 2.0
        //org.alicebot.ab.ab.MagicBooleans.trace("AIMLPreprocessor.normalize(node: " + node + ", ps: " + ")");
        String result = evalTagContent(node, ps, null);
        //org.alicebot.ab.ab.MagicBooleans.trace("in AIMLPreprocessor.normalize(), result: " + result);
		String returning = ps.chatSession.bot.preProcessor.normalize(result);
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLPreprocessor.normalize(), returning: " + returning);
        return returning;
    }
    /**
...
*/
    ...
    public static String javascript(Node node, ParseState ps) {
		//org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.javascript(node: " + node + ", ps: " + ps + ")");
    ...
    private static String recursEval(Node node, ParseState ps) {
		//org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.recursEval(node: " + node + ", ps: " + ps + ")");
        try {
			//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.recursEval(), node string: " + DomUtils.nodeToString(node));
        String nodeName = node.getNodeName();
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.recursEval(), nodeName: " + nodeName);
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.recursEval(), node.getNodeValue(): " + node.getNodeValue());
        if (nodeName.equals("#text")) return node.getNodeValue();
        else if (nodeName.equals("#comment")) {
            //org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.recursEval(), comment = "+node.getTextContent());
            return "";
        }
    ...
    public static String evalTemplate(String template, ParseState ps) {
		//org.alicebot.ab.ab.MagicBooleans.trace("AIMLProcessor.evalTemplate(template: " + template + ", ps: " + ps + ")");
		...
		//org.alicebot.ab.ab.MagicBooleans.trace("in AIMLProcessor.evalTemplate() returning: " + response);
        return response;
    }
    /**
